...
const DEFAULT_FILTERS = {
  ...
  onSale: false     // todo: Booleano per prodotti in sconto
};
      ...
      <div className="filter-group">
        ...
        <div className="filter-option">
          <input 
            type="checkbox" 
            id="on-sale" 
            name="onSale" // todo: Nome del campo booleano per sconti
            checked={filters.onSale} // todo: Stato del checkbox
            onChange={handleFilterChange}
          />
          <label htmlFor="on-sale">Solo prodotti in sconto</label>
        </div>
